function [wave_start,wave_end,date_start_string,date_end_string] = wave_detect_silent(dates, incidents, percent)
%wave_detect_silent Detects beginning and end of wave for a given percent
...
%   Surpresses any print to the console
