...
diagnostic_plot(temperature_data, y_regression_first, n, k);
...
diagnostic_plot(temperature_data, y_regression_second, n, k);
...
diagnostic_plot(temperature_data,y_regression_third, n, k);



function diagnostic_plot(y_values, y_hat, n, k)
